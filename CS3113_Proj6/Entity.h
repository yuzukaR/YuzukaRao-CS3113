...
enum AIType { WALKER, GUARD, PATROLLING};
...
public:
    ...
    bool thisleveltarget = false;
    int m_count = 0;
    bool m_delete = false;
    int next_screen = 2;
    bool m_fail = false;
    glm::vec3 m_patrol_point;
    glm::vec3 m_start_position;
    bool m_patrolling_towards_point = true;
    ...
    void const check_collision_y_boundary(Map* map);
    void const check_collision_x_boundary(Map* map);
    void ai_patrol();
