...
void initialise() {
    ...
    g_triangle_matrix = glm::mat4(1.0f);  // Defines every translation, rotations, or scaling applied to an object
    g_rectangle_matrix = glm::mat4(1.0f);
    g_projection_matrix = glm::ortho(-5.0f, 5.0f, -3.75f, 3.75f, -1.0f, 1.0f);  // Defines the characteristics of your camera, such as clip planes, field of view, projection method etc.
    g_triangle_matrix = glm::translate(g_rectangle_matrix, glm::vec3(1.0f, 0.0f, 0.0f));
...
void update() {
    ...
    const float SHRINK_FACTOR = 0.9f;  // grow by -1.0% / frame
    
    g_frame_counter += 0.05f*delta_time;
    bool g_is_growing = true;

    float growth_time = 0.5f;

    if (g_frame_counter >= growth_time) {
        g_frame_counter -= growth_time;
    ...
    */
    ...
    g_rectangle_matrix = glm::scale(g_rectangle_matrix, scale_vector);
    g_rectangle_matrix = glm::translate(g_rectangle_matrix, glm::vec3(TRAN_VALUE, TRAN_VALUE, 0.0f));
}
...
void render() {
    ...
    float vertices1[] = {
        -0.5f, -1.0f, 0.5f, -1.0f, 0.5f, 0.5f,  // triangle 1
        -0.5f, -1.0f, 0.5f, 0.5f, -0.5f, 0.5f   // triangle 2
    };
    ...
    float vertices2[] = {
     -0.5f, -1.5f, 0.5f, -1.5f, 0.5f, 0.5f,  // triangle 1
     -0.5f, -1.5f, 0.5f, 0.5f, -0.5f, 0.5f   // triangle 2
    };
